...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_file", type=str, default="/home/xinrui/projects/PCB_structure_layout/re-annotation/board_colors_v2.json")
    parser.add_argument("--image_dir", type=str, default="/home/xinrui/projects/data/ti_pcb/images_top")
    args = parser.parse_args()
    import sys
    sys.modules[__name__].DATA_FILE = args.data_file
    sys.modules[__name__].IMG_DIR = args.image_dir
