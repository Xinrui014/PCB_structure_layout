...
<div class="container">
    ...
    <div class="controls">
        ...
        <select id="filter-select" onchange="page=0;updateGallery()">
            ...
            <option value="R1">R1 (6-8px)</option>
            <option value="R2">R2 (8-12px)</option>
            <option value="R3">R3 (12-16px)</option>
            <option value="R4">R4 (16-22px)</option>
            <option value="R5">R5 (22-28px)</option>
            <option value="R6">R6 (28+px)</option>
